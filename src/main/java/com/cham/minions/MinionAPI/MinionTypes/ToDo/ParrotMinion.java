...
public class ParrotMinion extends Parrot implements Minion {
    public ParrotMinion(Location location) {
        super(EntityType.PARROT, ((CraftWorld)location.getWorld()).getHandle());
    }
